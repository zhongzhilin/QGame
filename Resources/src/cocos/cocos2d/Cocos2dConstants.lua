...
cc.Handler.ASSETSMANAGER_COMPARE_VERSION    = 34
cc.Handler.STUDIO_EVENT_LISTENER  = 35
cc.Handler.ARMATURE_EVENT         = 36
cc.Handler.EVENT_ACC              = 37
cc.Handler.EVENT_CUSTIOM          = 38
cc.Handler.EVENT_KEYBOARD_PRESSED = 39
cc.Handler.EVENT_KEYBOARD_RELEASED = 40
cc.Handler.EVENT_TOUCH_BEGAN      = 41
cc.Handler.EVENT_TOUCH_MOVED      = 42
cc.Handler.EVENT_TOUCH_ENDED      = 43
cc.Handler.EVENT_TOUCH_CANCELLED  = 44
cc.Handler.EVENT_TOUCHES_BEGAN    = 45
cc.Handler.EVENT_TOUCHES_MOVED    = 46
cc.Handler.EVENT_TOUCHES_ENDED    = 47
cc.Handler.EVENT_TOUCHES_CANCELLED = 48
cc.Handler.EVENT_MOUSE_DOWN       = 49
cc.Handler.EVENT_MOUSE_UP         = 50
cc.Handler.EVENT_MOUSE_MOVE       = 51
cc.Handler.EVENT_MOUSE_SCROLL     = 52
cc.Handler.EVENT_SPINE            = 53
cc.Handler.EVENT_PHYSICS_CONTACT_BEGIN = 54
cc.Handler.EVENT_PHYSICS_CONTACT_PRESOLVE = 55
cc.Handler.EVENT_PHYSICS_CONTACT_POSTSOLVE = 56
cc.Handler.EVENT_PHYSICS_CONTACT_SEPARATE = 57
cc.Handler.EVENT_FOCUS = 58
cc.Handler.EVENT_CONTROLLER_CONNECTED = 59
cc.Handler.EVENT_CONTROLLER_DISCONNECTED = 60
cc.Handler.EVENT_CONTROLLER_KEYDOWN = 61
cc.Handler.EVENT_CONTROLLER_KEYUP = 62
cc.Handler.EVENT_CONTROLLER_KEYREPEAT = 63
cc.Handler.EVENT_CONTROLLER_AXIS = 64
cc.Handler.EVENT_SPINE_ANIMATION_START = 65
cc.Handler.EVENT_SPINE_ANIMATION_END = 66
cc.Handler.EVENT_SPINE_ANIMATION_COMPLETE = 67
cc.Handler.EVENT_SPINE_ANIMATION_EVENT = 68
