...
---选中规模最大的那只部队
	{
		key = "Guide",
		data = {
				panelName = "UITroopPanel",
				widgetNameFunc = function()
					return "GuideChoosePanel" .. global.troopData:getMineTroopMaxNumForGuideTroopID()
				end,
				isShowLight = true,
				scaleY = 1,
			},
...
{
	key = "Guide",
	data = {panelName = "UITroopPanel",widgetName = "btn_edit_export10" ,
		widgetFunc = function()
		    local panel = global.panelMgr:getPanel("UITroopPanel")
			local  t = ccui.Helper:seekNodeByName(panel ,"GuideChoosePanel2"..global.troopData:getMineTroopMaxNumForGuideTroopID())
			return t 
		end
	},
	target = {239}
...
-- {
-- 	key = "Guide",
-- 	data = {panelName = "UITroopPanel",widgetName = "troops_list_bg10"}
-- },
